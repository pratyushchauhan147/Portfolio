...
const Sec2 = (props) => {
  ...
  return (
    <motion.div data-scroll  data-scroll-speed="0" initial={{opacity:0}} whileInView={{opacity:1}} className=' mt-5 p-2 w-full h-screen overflow-hidden flex justify-center items-center'>
      <div className="  relative p-3 w-[100vw] h-[100vh] rounded-3xl flex bg-white" >
