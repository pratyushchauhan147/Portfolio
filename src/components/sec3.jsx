    ...
    <div>
        ...
        <div className='w-full  mt-5 '>
            <div data-scroll  data-scroll-speed="0" className="top flex items-center justify-center  mix-blend-exclude ">
                <motion.a href='/projects' initial={{scale:0,opacity:0}} whileHover={{scale:1.05,backgroundColor:"#4a4aff"}}   whileInView={{scale:1 , opacity:1}} className='w-[40%] rounded-2xl  h-[20vw] m-2  flex justify-center  items-center bg-white'> <h1 className=' font-[anton] text-[5vw] text-black'>PROJECTS</h1></motion.a>
            ...
            <div data-scroll  data-scroll-speed="0" className="top flex justify-center ">
                ...
                <motion.a href='/myjourney'  initial={{scale:0,opacity:0}}  whileHover={{scale:1.05,backgroundColor:"#63ff92"}}   whileInView={{scale:1 , opacity:1}} className='w-[50%] rounded-2xl  h-[20vw] m-2  flex justify-center  items-center bg-white'> <h1 className=' font-[anton] text-[5vw] text-black'>MY JOURNEY</h1></motion.a>
                <motion.div initial={{scale:0,opacity:0}} whileInView={{scale:1 , opacity:1}} className='w-[20%] rounded-2xl  h-[20vw] m-2 bg-white'></motion.div>
            </div>
